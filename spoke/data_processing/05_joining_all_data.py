...
INPUT_FILE_TRIPS = abspath(join(DIR, '../../pipeline_data/trip_data_normalized.pkl.gz'))
INPUT_FILE_CRASHES = abspath(join(DIR, '../../pipeline_data/crash_data_normalized_with_node_graph.pkl.gz'))
INPUT_FILE_WEATHER = abspath(join(DIR, '../../pipeline_data/weather_data_normalized.pkl.gz'))

OUTPUT_FILE = abspath(join(DIR, '../../pipeline_data/unified_dataset.pkl.gz'))
